...
async def nutella_quesionaire(ctx: lightbulb.Context) -> None:
    ...
    if not have_view.result:
        return await ctx.respond(f"Looks like you need to get some before you can have some!")
    ...
    soul_question_selects.append(QuestionSelect("What is the texture of your soul?", textures))
    ...
    soul_question_selects.append(QuestionSelect("What is the color of your soul?", colors))
    ...
    soul_question_selects.append(QuestionSelect("What is the shape of your soul?", shapes))
    ...
    await ctx.respond(f"Were these your answers? {json.dumps(soul_view.answers, indent=4)}")
    ...
    day_selects.append(QuestionSelect("How many hours have you been awake so far?", hours_ranges))
    ...
    day_selects.append(QuestionSelect("What meals have you eaten today?", meals, max_values=len(meals)))
    ...
    await ctx.respond(f"Were these your answers? {json.dumps(day_view.answers, indent=4)}")
